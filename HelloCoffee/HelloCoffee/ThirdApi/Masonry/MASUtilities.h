...
//
    ...
    enum {
        MASLayoutPriorityRequired = (NSUInteger)UILayoutPriorityRequired,
        MASLayoutPriorityDefaultHigh = (NSUInteger)UILayoutPriorityDefaultHigh,
        MASLayoutPriorityDefaultMedium = 500,
        MASLayoutPriorityDefaultLow = (NSUInteger)UILayoutPriorityDefaultLow,
        MASLayoutPriorityFittingSizeLevel = (NSUInteger)UILayoutPriorityFittingSizeLevel,
    };
